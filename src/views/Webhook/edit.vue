	...
	<div class="col-md-4">
		<div class="box box-solid">
			<div class="box-header with-border">
				...
				<button v-if="vissibleButton" class="pull-right btn btn-primary" @click="updateSite">Save</button>
	...
	export default {
		...
		methods: {
			updateSite(){
				...
				axios.put('api/v1/site/' + this.form.id, this.form).then(response => {
			...
			fetchData(){
				axios.get('api/v1/site/' + this.$route.params.id + '/edit').then(response => {
